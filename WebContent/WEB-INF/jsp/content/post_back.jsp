...
<%String curPostId = (String)request.getParameter("postId");
System.out.println(curPostId);%>	<!-- 获取当前版块编号 -->
</head>
<body>
<div class="fastpost">
     <a name="posttopic"></a>
	...
	<div class="postbtn" style="margin-top:0px;z-index:3">  
       <img style="cursor:pointer;float:right;margin-right:20px;margin-top:50px" onclick="postdata();" src="images/showDetail/pn_reply.png">
    </div>
</div>
	<script>
	...
	/* UE.Editor.prototype.getActionUrl = function(action) {
	 ...
	 var postdata = function(){
			...
			if(html.trim()==""){
			  ...
			  $.ajax({
				type:'post',
				url:'content/replyPost',
				dataType:'json',
				
				data:{"content":html,"backThemeId":postId},
				success:function(result){
					if(result){
						// alert("回复成功");
						document.location.reload();		
						}else{
							alert("回复失败,请检查字数是否超出限制");
						}
					}
				});
