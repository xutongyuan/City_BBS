     ...
     <div class="home_rig_li home_rig_current" id="tagContents7" name="站内信">
         <div id="message">
             ...
             <div id="message_tagContent">
                 <div class="message_tagContent message_selectTag" id="message_tagContent1">
                     <table>
                     ...
                     <c:forEach items="<%=list %>" var="list">
                      <tr id="${list.messId }" align="center" valign="middle" style="font-weight: normal;">
                          <td>
                          ...
                          <td>
                              <a href="javascript:void(0)" onclick="showInfo('${list.messId}')" class="look">查看</a>
                              <font style="margin-left: 5px; margin-right: 5px; font-size: 12px;">/</font>
                              <a href="javascript:doPost('user/postmessage',{},'_self');">回复</a>
                              <font style="margin-left: 5px; margin-right: 5px; font-size: 12px;">/</font>
                     ...
                     <div class="pages" style="padding-top: 4px; float: left;">
                         <div class="page">
							<span class="page_1" ><a href="javascript:doPost('user/inbox',{'pageIndex':<%=tu.getPageNum()-1 %>},'_self')" style="color:black;" id="pre2">&nbsp;&nbsp;上一页&nbsp;</a></span>
							<span class="page_1">&nbsp;&nbsp;当前页：<%=tu.getPageNum() %>/总页数：<%=tu.getPages() %>&nbsp;</span>
							<span class="page_1"><a href="javascript:doPost('user/inbox',{'pageIndex':<%=tu.getPageNum()+1 %>},'_self')" style="color:black;" id="next2">&nbsp;&nbsp;下一页&nbsp;</a></span>
...
<script type="text/javascript">
        ...
        function showInfo(id) {
            tanchu_iframe("inboxTC.jsp?messId="+id, "好友留言", 730, 350);
        }
        function closeTC() {
            $("#tanchu_all").remove();
        }
