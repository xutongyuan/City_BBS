		...
		<div class="headall">
			<div class="headtop">
				<div class="allsearch">
					<div class="headsearch">
						<input id="txt_keyword" type="text" placehold="输入关键字" style="width: 343px; height: 33px; _height: 30px; +height: 30px; line-height: 33px; _line-height: 30px; line-height: 30px; padding-left: 5px; border: none; _border: 0px; color: 202020; font-size: 14px;" />
					</div>
					<a href="javascript:" title="马上搜索">
						<div class="headbtn" onclick="search();">
							搜索
						</div>
					</a>
			...
			<!--
			 <div class="headnav">
		        ...
		        <a href="index.jsp" class="a_first headcurrent">论坛首页</a>
		        </span>
						
						<span class="span_first">
		            <a href="javascript:void(0);" id="weixin_button" class="a_first">精华帖</a>
		        </span>
			...
			<div class="headmiddle">
				<div class="headlist">
					<ul>
						<li>
							<a href="content/getlist?area=1">我说潮州<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li>
							<a href="content/getlist?area=2">找男友<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li>
							<a href="content/getlist?area=3">找女友<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li>
							<a href="content/getlist?area=4">骑行交友</a>
						</li>
						<li>
							<a href="content/getlist?area=5">摄影交友</a>
						</li>
						<li>
							<a href="content/getlist?area=6">电影交友<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li>
							<a href="content/getlist?area=7">以茶会友</a>
						</li>
						<li>
							<a href="content/getlist?area=8">聚会party<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li>
							<a href="content/getlist?area=9">创业交流</a>
						</li>
						<li>
							<a href="content/getlist?area=10">健身交流</a>
						</li>
						<li>
							<a href="content/getlist?area=11">体育交流</a>
						</li>
						
						
						<li>
							<a href="content/getlist?area=12">爱吃一族<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li class="nbg">
							<a href="content/getlist?area=13">爱车一族<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li>
							<a href="content/getlist?area=14">家有儿女</a>
						</li>
						<li>
							<a href="content/getlist?area=15">家有宠物</a>
						</li>
						<li>
							<a href="content/getlist?area=16">游记分享</a>
						</li>
						<li>
							<a href="content/getlist?area=17">游戏讨论<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li>
							<a href="content/getlist?area=18">艺术园地</a>
						</li>
						<li>
							<a href="content/getlist?area=19">跳蚤市场</a>
						</li>
						<li>
							<a href="content/getlist?area=20">新闻时事<img class="hot_img" src="<%=basePath%>images/home/hot_0.gif" alt="HOT" /></a>
						</li>
						<li>
							<a href="content/getlist?area=21">开心一刻</a>
						</li>
						<li>
							<a href="content/getlist?area=22">灌水专区</a>
						</li>
			...
			<div class="headfoot" style="display: none;">
			</div>
